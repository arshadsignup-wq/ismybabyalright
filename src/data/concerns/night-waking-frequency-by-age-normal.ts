...
export const concern: ConcernPage = {
  ...
  whenNormal: [
    ...
    'Your baby\'s pattern not matching a friend\'s baby of the same age — individual variation is wide',
  ],
  whenToMention: [
    ...
    'You are so sleep-deprived that you feel unsafe driving or caring for your baby — discuss your own health with your provider',
  ],
  whenToActNow: [
    'Your baby has long pauses in breathing (more than 10-15 seconds) during sleep, followed by gasping — this requires evaluation for obstructive sleep apnea',
    'Your baby is difficult to wake from sleep, unusually limp, or unresponsive — this is a medical emergency',
    'Night wakings are accompanied by persistent fever, vomiting, or refusal to feed — these suggest illness needing evaluation',
  ],
  relatedMilestones: [],
