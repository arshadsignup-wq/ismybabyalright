...
export const concern: ConcernPage = {
  ...
  searchTerms: [
    ...
    'heat rash vs eczema baby',
    'how long does baby heat rash last',
    'baby heat rash car seat',
    'heat rash baby winter',
    'is heat rash contagious',
    'baby rash from overdressing',
    'newborn heat rash',
  ],
  quickAnswer:
  ...
  relatedConcernSlugs: [
    'baby-rash-in-skin-folds',
    'baby-chin-rash-from-drool',
    'baby-rash-around-mouth',
    'baby-raised-bumps-on-skin',
    'baby-rash-wont-go-away',
    'eczema',
    'diaper-rash',
    'baby-acne',
    'baby-rash-after-swimming',
