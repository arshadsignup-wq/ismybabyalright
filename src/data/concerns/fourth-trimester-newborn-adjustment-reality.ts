...
export const concern: ConcernPage = {
  ...
  whenNormal: [
    'Feeling overwhelmed, exhausted, and questioning your decision to have a baby — nearly every new parent has this experience',
    'Not feeling an instant magical bond — attachment develops over time through daily caregiving',
    'Crying (you and the baby) at unpredictable moments',
    'Missing your pre-baby life, identity, freedom, or relationship dynamic',
    'Feeling like other parents are handling it better — they are showing you their curated best moments, not their 3 AM reality',
  ],
  whenToMention: [
  ...
  whenToActNow: [
    ...
    'Hearing or seeing things that are not there, or feeling detached from reality — these are signs of postpartum psychosis, a medical emergency',
    'Unable to sleep at all even when baby sleeps, racing thoughts, or extreme agitation — this may indicate postpartum anxiety or mania',
  ],
  relatedMilestones: [],
