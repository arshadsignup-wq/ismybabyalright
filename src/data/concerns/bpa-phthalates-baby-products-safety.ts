...
export const concern: ConcernPage = {
  ...
  whenNormal: [
    'Your baby mouthing a BPA-free plastic toy — this level of exposure is low risk',
    'Not being able to eliminate all plastic from your baby\'s environment — this is unrealistic and unnecessary',
    'Using BPA-free plastic bottles when glass is impractical (daycare, travel) — the risk is low especially with cold/room temperature liquids',
    'Feeling confused by "BPA-free" marketing — your skepticism is warranted, and seeking alternatives is reasonable',
  ],
  whenToMention: [
  ...
  whenToActNow: [
    ...
    'You notice a recalled product in your home that contains banned chemicals — stop use and follow CPSC recall instructions',
