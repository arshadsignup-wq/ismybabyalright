...
export const concern: ConcernPage = {
  ...
  quickAnswer:
    'Many babies dislike tummy time, especially in the first few weeks — this is one of the most common frustrations new parents face. The AAP recommends supervised tummy time starting from day one to build neck, shoulder, and core strength and prevent flat spots (positional plagiocephaly). However, tummy time does not have to mean placing your baby flat on the floor. Effective alternatives include: tummy-to-chest time (lying baby on your chest while you recline), the football hold (carrying baby face-down along your forearm), tummy time on your lap, using a rolled towel under the chest for support, and babywearing in a carrier. Even 1-2 minutes at a time counts — the AAP recommends working up to 15-30 minutes total per day by 7 weeks. Short, frequent sessions are more effective and better tolerated than one long session.',
  byAge: [
    {
      ageRange: '0-6 weeks',
      context:
        'Start with tummy-to-chest time, which most newborns tolerate well because of skin-to-skin contact and your heartbeat. Place baby on your chest while you are reclined at a 45-degree angle — this counts as tummy time per the AAP. The football hold (carrying baby face-down along your forearm with their head near your elbow) is another option. Aim for a few minutes after each diaper change. Most newborns will fuss after 1-2 minutes and that is normal — stop, comfort, and try again later.',
    },
    {
      ageRange: '6 weeks to 3 months',
      context:
        'Gradually introduce floor tummy time with support. Place a rolled-up towel or small nursing pillow under your baby\'s chest so their arms are propped forward — this reduces the work their neck muscles have to do. Get down on the floor at eye level and use high-contrast toys, a mirror, or your face to engage them. Tummy time across your lap while you gently pat their back is another well-tolerated option. Aim for 15-30 minutes total daily, broken into short sessions.',
    },
    {
      ageRange: '3-4 months',
      context:
    ...
    },
    {
      ageRange: '4-6 months',
      context:
        'By this age, many babies who previously hated tummy time are now comfortable and may even prefer it as they work toward rolling and eventually crawling. If your baby is still strongly resistant, talk to your pediatrician — occasionally, discomfort during tummy time can signal reflux, torticollis (tight neck muscle), or sensory sensitivity. Physical therapy can help if there is an underlying issue. Most babies, however, simply needed time and gradual exposure.',
    },
  ],
  whenNormal: [
  ...
  whenToMention: [
    ...
    'Baby always turns their head to one side and resists turning the other way — may indicate torticollis',
  ...
  whenToActNow: [
    'Baby has no head control and their head consistently flops forward or to the side by 4 months — this may indicate a motor delay needing evaluation',
    'Baby arches their back and screams during tummy time consistently, especially after feeds — could indicate significant reflux requiring treatment',
